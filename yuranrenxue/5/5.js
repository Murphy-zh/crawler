...
// VM507:6 _$Jy -405537848 _$tT -660478335 _$6_ -389564586
...
var _0xceb4b2 = []
    ...
    var  _0x2b11f1 = _0x30bc70[_0xceb4b2[0x114]];
...
function _0x11a7a2(_0x193f00, _0x1cfe89) {
    ...
    try {
        ...
        // op = 26 //Array(_0x4e96b4['$_zw'])[_$UH[0x6c]];
...
function get_md5(ts){
    var md5_m = _0x474032(ts);
    return md5_m
}


function get_RM4hZBv0dDon443M(ts){
    md5_m = get_md5(ts)

    _0x4e96b4['_$qF'] = CryptoJS.enc.Utf8.parse(window.btoa(ts.toString()).slice(0,16))
    ...
    var _0x29dd83 = CryptoJS.AES.encrypt($Ww,_0x4e96b4['_$qF'],{
        'mode': CryptoJS.mode.ECB,
        'padding':CryptoJS.pad.Pkcs7})

    _0x4e96b4["ss"] =  _0x29dd83.toString();
    // console.log(md5_m,_0x4e96b4["ss"])
    para = {
        "md5_m" :  md5_m,
        "RM4hZBv0dDon443M":  _0x4e96b4["ss"]
    }
...
// 加密前: 1614845889060 加密后: c3b8a4ba551afda093fd9ca1ae6055bd
// RM4hZBv0dDon443M   AkgxcCtSiBNM4f5JAQzzFPFMtnGd/Pzcg31Rel5tWm6gPPMaX9EZs219+pFJXHVsQBHk9njmg/eTrKkIPyUmNngM4+wh5ZLkfvVzgpAHSI/0bjDMvlN4mm0jUructjJdi3Gpc+SGycLWGobI3m6n5EYPgqGCFQVaenSMWFBYSLj+VttWJgg4Oc66zdyvcg4HQndZSY06WLnoXRlf/XXtpyYZ+YN0Qdjvp8/NjJPVfcQ=
var ts = "1616743488876"
para = get_RM4hZBv0dDon443M(ts)
console.log(para)
